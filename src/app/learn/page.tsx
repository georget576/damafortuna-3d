    ...
    switch (selectedModule) {
      ...
      case 'cards':
        return (
          <div className="space-y-6">
            <div className="mb-6">
              <h2 className="text-2xl font-bold mb-2 font-caveat-brush text-purple-200">Card Meanings</h2>
      ...
      case 'exercises':
        return (
          <div className="space-y-6">
            <div className="mb-6">
              <h2 className="text-2xl font-bold mb-2 font-caveat-brush text-purple-200">Practice Exercises</h2>
              <p className="text-lg text-gray-300 font-shadows-into-light">
